 ...
 */
public class RotationVectorSensorEventListener extends MySensorEventListener {
    public RotationVectorSensorEventListener(TextView outputView, TextView max, LineGraphView lineGraph) {
